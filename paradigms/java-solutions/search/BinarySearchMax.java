...
import static search.BinarySearchShift.arr;
import static search.BinarySearchShift.findShift;
...
public class BinarySearchMax {
    ...
    static int findShift() {
        ...
        return (l+ arr.length)% arr.length;
    }
    // Post: shift
    ...
    public static void main(String[] args) {
        ...
        // Pred: arr[i]!=arr[j], i!=j && ∃!x: (arr[0..x) - убыв, arr[x..arr.len) -убыв, arr[x]=max(arr))
        System.out.print(arr[findShift()]);
        // Post: printed shift
    }
}
